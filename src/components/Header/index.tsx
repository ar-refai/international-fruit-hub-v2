...
const Header = () => {
  ...
  return (
    <>
      <header
        className={`header left-0 top-0 z-40 flex w-full ${
          shrunk ? "shrunk" : ""
        } items-center ${
          "dark:bg-white dark:shadow-sticky-dark h-32  fixed z-[9999] bg-white shadow-sticky backdrop-blur-lg transition"
        }`}
      >
                          ...
                          <Link
                            ...
                            className={`flex py-2 text-base lg:mr-0 lg:inline-flex lg:px-0 lg:py-6 ${
                              usePathName === menuItem.path
                                ? "text-primary "
                                : "text-dark hover:text-primary text-black"
                            }`}
                          >
                            {menuItem.title}
                          </Link>
