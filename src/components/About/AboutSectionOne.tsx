          ...
          <div className="-mx-4 flex flex-wrap items-center">
              ...
              <div className="mb-12 max-w-[570px] lg:mb-0" data-wow-delay=".15s">
                <div className="mx-[-12px] flex flex-wrap">
                  <div className="w-full px-3 sm:w-1/2 lg:w-full xl:w-1/2">
                    <List text="Premium quality fruits and vegetables" />
                    <List text="Tailwind CSS for a modern UI" />
                    <List text="Lifetime use and satisfaction" />
                  </div>

                  <div className="w-full px-3 sm:w-1/2 lg:w-full xl:w-1/2">
                    <List text="Powered by Next.js" />
                    <List text="Rich documentation for easy integration" />
                    <List text="Developer-friendly approach" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="w-full px-4 lg:w-1/2">
              <div className="relative mx-auto aspect-[25/24] max-w-[500px] lg:mr-0">
                <Image
                  src="/images/about/vegs1.png"
                  alt="about-image"
                  width={800}
                  height={800}
                  className="mx-auto max-w-full hover:scale-110 transition-all ease duration-300  drop-shadow-three dark:hidden dark:drop-shadow-none lg:mr-0"
                />
                <Image
                  src="/images/about/vegs1.png"
                  alt="about-image"
                  width={800}
                  height={800}
                  className="mx-auto hidden hover:scale-110 transition-all ease duration-300 max-w-full drop-shadow-three dark:block dark:drop-shadow-none lg:mr-0"
                />
              </div>
            </div>
          </div>
